/**
 * @license AngularJS v1.2.11-build.local+sha.766b3d5
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.11-build.local+sha.766b3d5/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.11-build.local+sha.766b3d5',    // all of these placeholder strings will be replaced by grunt's
